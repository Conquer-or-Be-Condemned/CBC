...
public class TowerManager : MonoBehaviour
{
    ...
    private void SetCanonTowerInfo()
    {
        ...
        powerText.SetText("Power : " + (curCanonTower.GetPower() / (float)DataManager.ControlUnitPower * 100)+"%");
    ...
    private void SetMissileTowerInfo()
    {
        ...
        powerText.SetText("Power : " + (curMissileTower.GetPower()/ (float)DataManager.ControlUnitPower * 100)+"%");
